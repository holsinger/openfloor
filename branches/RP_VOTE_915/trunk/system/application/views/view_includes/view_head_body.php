...
?>
	<div id="page">
		...
		<div id="header">
			...
			<div id="userLogin">Welcome, <?=anchor("user/profile/{$this->userauth->user_name}",$this->userauth->display_name);?>&nbsp;(<span onClick="showBox('karma_explained');" class='link'><?=$this->userauth->user_karma;?></span><img src="./images/karma_star_default.png" style='top:4px;'>)&nbsp;|&nbsp;<?=anchor('user/profile/'.$this->userauth->user_name,'Manage Account');?>&nbsp;|&nbsp;<?=anchor('user/logout/',"Logout");?></div>
			<? } else { ?>
