<?php require_once('C:\php5\htdocs\p20\plugins\modifier.escape.php'); $this->register_modifier("escape", "tpl_modifier_escape");  $this->config_load("/libs/lang.conf", null, null); ?>
														<div id="center">
															<div class="ce-l">
																<div class="ce-r">
																	<div class="ce-lt">
																		<div class="ce-br">
																			<div class="text">
																				...
																				<div id="comments">
<h2><?php echo $this->_confs['PLIGG_Visual_Submit3_Header']; ?>
</h2>
<?php echo $this->_confs['PLIGG_Visual_Submit3_Details']; ?>
...
" />
		<input type="hidden" name="trackback" value="<?php echo $this->_run_modifier($_POST['trackback'], 'escape', 1, "html"); ?>
" />
