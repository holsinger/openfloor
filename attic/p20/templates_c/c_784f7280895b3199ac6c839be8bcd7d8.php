														...
														<?php 
														 ...
														 ?>
														<span class="latest-comments"><?php echo $this->_confs['PLIGG_Visual_Comments']; ?>
</span></h3>
														<div class="box" id="sr">
															<ul class="list-rss">
<?php 
 ...
 ?>
																<li>
																	<a href="<?php echo $this->_vars['URL_storytitle'];  echo $link->title_url ?>"><?php echo $link->title; ?></a><br />
