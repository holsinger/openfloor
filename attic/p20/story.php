...
if(isset($_REQUEST['category'])){$thecat = $db->get_var("SELECT category_name FROM " . table_categories . " WHERE `category_safe_name` = '".strip_tags($_REQUEST['category'])."';");}
...
function get_comments (){
       ...
       Global $db, $main_smarty, $current_user, $CommentOrder, $link;
			...
			//Set comment order to 1 if it's not set in the config.php
