...
// }
	...
	class db {
		...
		function db($dbuser, $dbpassword, $dbname, $dbhost)
		{
			...
			if ( ! $this->dbh )
			{
				$this->print_error('<ol><b>Error establishing a database connection!</b><li>Are you sure you have the correct user/password?<li>Are you sure that you have typed the correct hostname?<li>Are you sure that the database server is running?<li>Have you run the <a href = "./install/">Pligg Installer?</a></ol>');
				die;
			}
