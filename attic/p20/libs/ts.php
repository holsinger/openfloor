...
function ts_print_form() {
	$ts_random=rand();
	echo _("Please enter the number provided in the image below.  If you can not read the number you may refresh your browser")."<br /><br />\n";
	echo '<table><tr><td>';
	echo '<input type="hidden" name="ts_random" value="'.$ts_random.'" />';
	echo '<img src="/ts_image.php?ts_random='.$ts_random.'" class="ch2" /></td>';
