<?php
/**
 * Template Lite fetch_compile_include template internal module
 *
 * Type:	 template
 * Name:	 fetch_compile_include
 */

function fetch_compile_include($_templatelite_include_file, $_templatelite_include_vars, &$object)
{
	if ($object->debugging)
	{
