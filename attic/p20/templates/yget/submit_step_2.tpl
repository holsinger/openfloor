...
<form action="{$URL_submit}" method="post" name="thisform" id="thisform">
	...
	<fieldset><legend>{#PLIGG_Visual_Submit2_Details#}</legend>
		...
		<br/><input type="text" id="title" class="text" name="title" onclick="clearText(this, '{$submit_url_title}')" onblur="restoreText(this,'{$submit_url_title}')" value="{$submit_url_title}" size="60" maxlength="100" />
		</p>
		<br />
