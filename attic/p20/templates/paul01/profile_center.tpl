 ...
 {if $savemsg neq ""}{$savemsg}{/if}
	<fieldset>
		...
		<form action="" method="post" id="thisform">
					...
					{*<input type="radio" name="avatarsource" value="gravatar" {if $user_avatar_source eq "gravatar"}CHECKED{/if}> I want to use a Gravatar.<br />*}
			...
			<input type="text" name="email" id="email" tabindex="3" value="{$user_email}"> <em style="font-size:9px;"><br />
			{#PLIGG_Visual_Profile_OnlyAdmins#}</em>
			</p></td>
