...
<h2 style="border-bottom:1px solid #ccc; padding-top:5px">{#PLIGG_Visual_Pligg_Queued#} </h2>
...
<h2 style="border-bottom:1px solid #ccc; padding-top:5px">{#PLIGG_Visual_Published_News#}</h2>
{/if}
