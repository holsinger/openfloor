...
{php}
	...
	//$main_smarty->display($the_template . '/submit_step_3-2.tpl');
...
{/php}
	...
	<input type="submit" onclick="javascript:submitEdgeStory();"  value="{#PLIGG_Visual_Submit3_SubmitStory#}" class="submit" />
