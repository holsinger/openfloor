...
<div id="regtab" style="display:none;padding: 4px 0 0 4px;">		
				<form action="{$my_pligg_base}/register.php" method="post" id="thisform">				
					{#PLIGG_Visual_Register_Username#}:<br />
					<input type="text" name="username" id="name" value="" onkeyup="enablebutton(this.form.checkbutton1, this.form.submit, this)" size="15" tabindex="1" class="login"/><br />

					{#PLIGG_Visual_Register_Email#}:<br />
					<input type="text" id="email" name="email" value=""  onkeyup="enablebutton(this.form.checkbutton2, this.form.submit, this)" size="15" tabindex="2"/><br />

					{#PLIGG_Visual_Register_Password#}:<br />
					<input type="password" id="password" name="password" size="15" tabindex="3"/><br />
					
					{#PLIGG_Visual_Register_Verify_Password#}:<br />
					<input type="password" id="verify" name="password2" size="15" tabindex="4"/><br />

					<input type="submit" name="submit" value="{#PLIGG_Visual_Register_Create_User#}" class="log2" tabindex="6" /><br />
						{php}
