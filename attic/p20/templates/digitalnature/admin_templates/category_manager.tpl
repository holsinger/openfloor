...
<hr />
<br />
 <em>If you're using URLMethod 2, you'll want to use this line in your .htaccess file. <br /><b>Note: Refresh this page to make sure the following code is correct.</b><br /><br />
