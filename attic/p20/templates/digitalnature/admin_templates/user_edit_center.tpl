...
<tr>
  <td>Login:</td> <td> <input name=login value="{$userdata[nr].user_login}" size="30"></td>
</tr>
...
<tr>
  <td>Email:</td> <td> <input name=email value="{$userdata[nr].user_email}" size="30"></td>
</tr>
...
<tr>
  <td><input type=submit name=mode value="{#PLIGG_Visual_Profile_Save#}" class="log2">
      <input type=button onclick="window.history.go(-1)" value="{#PLIGG_Visual_View_User_Edit_Cancel#}" class="log2">
 </td>
</tr>
