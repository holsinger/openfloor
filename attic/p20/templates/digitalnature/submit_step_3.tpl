...
{php}
	...
	//$main_smarty->display($the_template . '/submit_step_3-1.tpl');
...
{/php}
	...
	<table>
	<tr>
	<td><input type=button onclick="javascript:gPageIsOkToExit=true;window.history.go(-1);" value="{#PLIGG_Visual_Submit3_Modify#}" class="log2"></td><td>&nbsp;&nbsp;&nbsp;</td>
	<td><input type="submit" onclick="javascript:submitEdgeStory();" value="{#PLIGG_Visual_Submit3_SubmitStory#}" class="submit" /></td>
	</tr>
	</table>
