...
<h2 style="margin:0px;border:none;">{$page_header}</h2>
...
<div id="cab" style="margin:0px">
	<ul class="postin">
			<li><img src="{$my_pligg_base}/templates/{$the_template}/images/rss.png" border="0" alt="" /><a href="{$user_rss, "all"}">RSS</a></li>
...
<div id="cab" style="margin:0px">
	<ul class="postin">
			<li><img src="{$my_pligg_base}/templates/{$the_template}/images/rss.png" border="0" alt="" /><a href="{$user_rss, "published"}">RSS</a></li>
	    <li><a href="{$user_url_personal_data}" class="navbut3"><span>{#PLIGG_Visual_User_PersonalData#}</span></a></li>
...
<div id="cab" style="margin:0px">
	<ul class="postin">
			<li><img src="{$my_pligg_base}/templates/{$the_template}/images/rss.png" border="0" alt="" /><a href="{$user_rss, "queued"}">RSS</a></li>
	    <li><a href="{$user_url_personal_data}" class="navbut3"><span>{#PLIGG_Visual_User_PersonalData#}</span></a></li>
	    <li><a href="{$user_url_news_sent}" class="navbut3"><span>{#PLIGG_Visual_User_NewsSent#}</span></a></li>
	    <li><a href="{$user_url_news_published}" class="navbut3"><span>{#PLIGG_Visual_User_NewsPublished#}</span></a></li>
...
<div id="cab" style="margin:0px">
	<ul class="postin">
			<li><img src="{$my_pligg_base}/templates/{$the_template}/images/rss.png" border="0" alt="" /><a href="{$user_rss, "commented"}">RSS</a></li>
	    <li><a href="{$user_url_personal_data}" class="navbut3"><span>{#PLIGG_Visual_User_PersonalData#}</span></a></li>
	    <li><a href="{$user_url_news_sent}" class="navbut3"><span>{#PLIGG_Visual_User_NewsSent#}</span></a></li>
	    <li><a href="{$user_url_news_published}" class="navbut3"><span>{#PLIGG_Visual_User_NewsPublished#}</span></a></li>
	    <li><a href="{$user_url_news_unpublished}" class="navbut3"><span>{#PLIGG_Visual_User_NewsUnPublished#}</span></a></li>
...
<div id="cab" style="margin:0px">
	<ul class="postin">
			<li><img src="{$my_pligg_base}/templates/{$the_template}/images/rss.png" border="0" alt="" /><a href="{$user_rss, "voted"}" >RSS</a></li>
	    <li><a href="{$user_url_personal_data}" class="navbut3"><span>{#PLIGG_Visual_User_PersonalData#}</span></a></li>
	    <li><a href="{$user_url_news_sent}" class="navbut3"><span>{#PLIGG_Visual_User_NewsSent#}</span></a></li>
	    <li><a href="{$user_url_news_published}" class="navbut3"><span>{#PLIGG_Visual_User_NewsPublished#}</span></a></li>
	    <li><a href="{$user_url_news_unpublished}" class="navbut3"><span>{#PLIGG_Visual_User_NewsUnPublished#}</span></a></li>
...
{if $UseAvatars neq "0"}<span id="ls_avatar-{$link_shakebox_index}"><img src="{$Avatar_ImgSrc}" alt="" /></span>{/if}
<div id="cab" style="margin:0px">
	<ul class="postin">
	    <li><a href="{$user_url_personal_data}" class="navbut3"><span>{#PLIGG_Visual_User_PersonalData#}</span></a></li>
	    <li><a href="{$user_url_news_sent}" class="navbut3"><span>{#PLIGG_Visual_User_NewsSent#}</span></a></li>
...
<div id="navbar" style="margin:0px;">
	...
	<img src="{$my_pligg_base}/templates/{$the_template}/images/rss.png" alt="" /> 
	<a href="{$user_rss, "published"}">{#PLIGG_Visual_User_Profile_View_RSS#} {$user_login}'s {#PLIGG_Visual_User_Profile_View_RSS_2#}</a><br />
	{* display "people who've add me as a friend" link *}
	<img src="{$my_pligg_base}/templates/{$the_template}/images/friends2.png" alt="" /> 
...
{if $UseAvatars neq "0"}<span id="ls_avatar-{$link_shakebox_index}"><img src="{$Avatar_ImgSrc}" style="float:left" alt="" /></span>{/if}
<div id="cab" style="margin:0px">
	<ul class="postin">
	    <li><a href="{$user_url_personal_data}" class="navbut3"><span>{#PLIGG_Visual_User_PersonalData#}</span></a></li>
	    <li><a href="{$user_url_news_sent}" class="navbut3"><span>{#PLIGG_Visual_User_NewsSent#}</span></a></li>
...
<div id="navbar" style="margin:0px;">
	...
	<img src="{$my_pligg_base}/templates/{$the_template}/images/friends.png" alt="" />
...
<div id="navbar" style="margin:0px;">
	{if $Allow_Friends neq "0"}	
		...
		<img src="{$my_pligg_base}/templates/{$the_template}/images/friends.png" alt="" />
		<a href="{$user_url_friends}">{#PLIGG_Visual_User_Profile_View_Friends#}</a><br />
		<img src="{$my_pligg_base}/templates/{$the_template}/images/friends2.png" alt="" />
		<a href="{$user_url_friends2}">{#PLIGG_Visual_User_Profile_View_Friends_2#}</a>
...
{if $Allow_Friends neq "0"}	
		...
		{if $user_login neq $user_logged_in}
			...
			<img src="{$my_pligg_base}/templates/{$the_template}/images/user_delete.png" alt="" />
			<a href="{$user_url_remove}">{#PLIGG_Visual_User_Profile_Remove_Friend#} {$user_login} {#PLIGG_Visual_User_Profile_Remove_Friend_2#}</a><br />
			...
			{else}
				...
				<img src="{$my_pligg_base}/templates/{$the_template}/images/user_add.png" alt=""/>
				<a href="{$user_url_add}">	{#PLIGG_Visual_User_Profile_Add_Friend#} {$user_login} {#PLIGG_Visual_User_Profile_Add_Friend_2#}</a><br />
