...
<div id="ucp">
	...
	<div class="section">
		...
		<span style="float:right;padding-top:3px;cursor:pointer; margin-top: -20px">
			<span>Show: </span>
			<? if(!$event_data["event_finished"]): ?>
				<span id="sort-link-duplicate" title="Duplicates" class="cp-sort-link" onClick="cpUpdater.change_sort('duplicate')">Duplicates</span> |
				<span id="sort-link-inappropriate" title="Inappropriate" class="cp-sort-link" onClick="cpUpdater.change_sort('inappropriate')">Inappropriate</span> |
				<? if ($this->userauth->isAdmin()):?>
				<span id="sort-link-private" title="Private" class="cp-sort-link" onClick="cpUpdater.change_sort('private')">Private</span> |
				<? endif;?>
				<span id="sort-link-promot" title="Promoted" class="cp-sort-link" onClick="cpUpdater.change_sort('promot')">Promoted</span> |
