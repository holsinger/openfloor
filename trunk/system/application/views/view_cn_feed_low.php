...
<?if (!$blocked) { ?>
	...
	<param name="FlashVars" value="&bgColor=0xFFFFFF&serverName=wmssdemo3.flashsvc.vitalstreamcdn.com&appName=wmssdemo3_vitalstream_com/_definst_&streamName=live_P20_SLC_Low&autoPlay=true&skinName=http://http.vitalstreamcdn.com/flashskins/clearSkin_1&bufferTime=3&autoRewind=true " /> 
	<embed src="http://http.vitalstreamcdn.com/flashskins/FLVPlayer.swf " flashvars="&bgColor=0xFFFFFF&configFile=&serverName=wmssdemo3.flashsvc.vitalstreamcdn.com&appName=wmssdemo3_vitalstream_com/_definst_&streamName=live_P20_SLC_Low&autoPlay=true&skinName=http://http.vitalstreamcdn.com/flashskins/clearSkin_1&bufferTime=3&autoRewind=true " quality="high" scale="showall" width="320" height="240" name="FLVPlayer" align="" salign="LT" type="application/x-shockwave-flash" pluginspage=" http://www.macromedia.com/go/getflashplayer" />
	 </object>
...
<? } ?>
<?=anchor('information/videoFeed/' . url_title($event_name), 'High bandwidth feed')?>
</div>
</body>
</html>