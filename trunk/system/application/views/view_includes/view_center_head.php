											...
											<div class="bg3">
												<div class="bg">
													<div class="top-box">
														...
														<? if ($tabs) { ?>
														<ul class="local-nav">
																<li class=""><a onclick="showBox('event_dashboard');window.open('index.php/conventionnext/cp/<?=str_replace('event/','',$event_url);?>', '_blank', 'width=1015,height=700,scrollbars=yes,status=no,resizable=yes,screenx=0,screeny=0');" href="javascript:void(0);" class='published-questions'>Event Dashboard</a></li>
