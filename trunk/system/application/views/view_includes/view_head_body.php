...
?>
	<div id="page">
		...
		<div id="header">
			...
			<div id="userLogin">Welcome, <?=anchor("user/profile/{$this->session->userdata('user_name')}",$this->session->userdata('user_name'));?>&nbsp;(<?=$this->userauth->user_karma;?>)&nbsp;|&nbsp;<a href="index.php/user/profile/<?=$this->session->userdata('user_name');?>">Manage Account</a>&nbsp;|&nbsp;<a href="index.php/user/logout/">Logout</a></div>
			<? } else { ?>
