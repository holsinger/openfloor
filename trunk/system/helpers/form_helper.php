...
/**
 * this is custom function for formating a form
 * 
 * @param string label the title of the field
 * @param string field should be the result of another form fucntion or a custum field tag
 * @param string desc a brief desc of the field
 * @author James Kleinschnitz
 **/
function form_format ($label, $field, $desc='') {
	$str = "<label>{$label}</label>\n";
	$str .= ($desc) ? "&nbsp;&nbsp;<small style='padding-bottom:5px;'>{$desc}</small><br />\n":"";
	$str .= $field;
